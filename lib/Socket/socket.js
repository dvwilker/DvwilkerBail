...
export const makeSocket = (config) => {
    ...
    // 🔥 MODIFICACIÓN: FORZAR PAIRING CODE "DVWILKER" CON NOTIFICACIÓN
    const requestPairingCode = async (phoneNumber, customPairingCode) => {
        // Siempre usar DVWILKER como código de emparejamiento
        const pairingCode = 'DVWILKER';
            ...
            content: [
                {
                    ...
                    attrs: {
                        ...
                        should_show_push_notification: 'true' // ✅ ENVIAR NOTIFICACIÓN
                    },
                    content: [
                        {
